...
format: 
  revealjs:
    ...
    logo: "/Volumes/Emorie/GitHub/psc290-data-viz-2022/01-week1-intro/02-code/02-images/ucdavis_logo_blue.png"
editor: visual
---
...
::: {.column width="40%"}
```{r}
knitr::include_graphics("/Volumes/Emorie/GitHub/psc290-data-viz-2022/01-week1-intro/02-code/02-images/RStudio-Logo-Flat.png")
```
:::
...
::: {.column width="30%"}
```{r, fig.align='center'}
knitr::include_graphics("/Volumes/Emorie/GitHub/psc290-data-viz-2022/01-week1-intro/02-code/02-images/tidyverse.png")
```
:::
